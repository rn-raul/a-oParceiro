       ...
       // StringBuilder nomesRetornados = new StringBuilder();
        ...
        // Sessão JAPE (necessária em muitos ambientes para usar JdbcWrapper/NativeSql)
            ...
            try {
            	...
            	// =======================
            	Registro reg = ctx.novaLinha("TGFPAR"); // TGFPAR
            	...
            	mensagem.append("Parceiro ");
            	mensagem.append(reg.getCampo("CODPARC"));
            	mensagem.append(" - ");
            	mensagem.append(reg.getCampo("NOMEPARC"));
            	mensagem.append(" criado com sucesso!");
